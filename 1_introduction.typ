...
Still, it is necessary to develop new ciphers and protocols already, as it takes time and plenty of research to become confident in the security of a new cryptographic system.
...
The @ietf Internet-Draft "Hybrid key exchange in TLS~1.3" @tls1.3_hybrid describes a solution to that, and browsers are in the process of rolling it out already. @chrome_kyber @firefox_125_nightly
...
This work is investigating the proposal for @mtc:pl.
We built the first @tls implementation of the Internet-Draft to demonstrate that the draft fundamentally works.
...
Additionally, we analyzed the reduction of the message size and provide size estimates for the regular updates that become necessary with the new architecture.
