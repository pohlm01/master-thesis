...
The server has an @mtc certificate and a fallback X.509 certificate available.
...
#figure(
  chrome_releases,
  caption: [Last few Chrome release dates~@chrome_releases]
) <tab:chrome_release>

#figure(
  firefox_releases,
  caption: [Last few Firefox release dates~@firefox_releases and sizes of consecutive updates~@firefox_update_size]
) <tab:firefox_release>